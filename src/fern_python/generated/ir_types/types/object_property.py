...
class ObjectProperty(WithDocs):
    ...
    def _validate_name(cls, name: WireStringWithAllCasings) -> WireStringWithAllCasings:
        for validator in ObjectProperty.Validators._name:
            name = validator(name)
        return name

    @pydantic.validator("value_type")
    def _validate_value_type(cls, value_type: TypeReference) -> TypeReference:
        for validator in ObjectProperty.Validators._value_type:
        ...
        def field(cls, field_name: str) -> typing.Any:
            def decorator(validator: typing.Any) -> typing.Any:
                if field_name == "name":
                    ...
                    raise RuntimeError("Field does not exist on ObjectProperty: " + field_name)
