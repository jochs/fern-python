        ...
        def field(cls, field_name: str) -> typing.Any:
            def decorator(validator: typing.Any) -> typing.Any:
                if field_name == "fern_filepath":
                    ...
                    raise RuntimeError("Field does not exist on DeclaredErrorName: " + field_name)
