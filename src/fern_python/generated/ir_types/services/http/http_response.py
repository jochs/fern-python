...
class HttpResponse(WithDocs):
    ...
    def _validate_type(cls, type: TypeReference) -> TypeReference:
        for validator in HttpResponse.Validators._type:
            type = validator(type)
        return type
    ...
    def _validate_type_v_2(cls, type_v_2: typing.Optional[TypeReference]) -> typing.Optional[TypeReference]:
        for validator in HttpResponse.Validators._type_v_2:
        ...
        def field(cls, field_name: str) -> typing.Any:
            def decorator(validator: typing.Any) -> typing.Any:
                if field_name == "type":
                    ...
                    raise RuntimeError("Field does not exist on HttpResponse: " + field_name)
