...
class WebSocketResponse(WithDocs):
    ...
    def _validate_type(cls, type: typing.Optional[TypeReference]) -> typing.Optional[TypeReference]:
        for validator in WebSocketResponse.Validators._type:
            type = validator(type)
        return type
        ...
        def field(cls, field_name: str) -> typing.Any:
            def decorator(validator: typing.Any) -> typing.Any:
                if field_name == "type":
                    ...
                    raise RuntimeError("Field does not exist on WebSocketResponse: " + field_name)
