...
class DoublyLinkedListNodeAndListValue(pydantic.BaseModel):
    ...
    class Validators:
        ...
        class NodeIdValidator(typing_extensions.Protocol):
            def __call__(self, *, node_id: NodeId, values: DoublyLinkedListNodeAndListValue.Partial) -> NodeId:
                ...

        class FullListValidator(typing_extensions.Protocol):
            def __call__(
                self, *, full_list: DoublyLinkedListValue, values: DoublyLinkedListNodeAndListValue.Partial
    ...
    def _validate_node_id(cls, node_id: NodeId, values: DoublyLinkedListNodeAndListValue.Partial) -> NodeId:
    ...
    def _validate_full_list(
        cls, full_list: DoublyLinkedListValue, values: DoublyLinkedListNodeAndListValue.Partial
    ) -> DoublyLinkedListValue:
        for validator in DoublyLinkedListNodeAndListValue.Validators._full_list_validators:
            full_list = validator(full_list, values=values)
        return full_list
