...
class BinaryTreeValue(pydantic.BaseModel):
    ...
    def _validate_root(cls, root: typing.Optional[NodeId], values: BinaryTreeValue.Partial) -> typing.Optional[NodeId]:
        for validator in BinaryTreeValue.Validators._root_validators:
            root = validator(root, values=values)
        return root

    @pydantic.validator("nodes")
    def _validate_nodes(
        cls, nodes: typing.Dict[NodeId, BinaryTreeNodeValue], values: BinaryTreeValue.Partial
    ) -> typing.Dict[NodeId, BinaryTreeNodeValue]:
