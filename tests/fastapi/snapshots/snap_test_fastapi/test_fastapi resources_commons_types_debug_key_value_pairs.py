...
class DebugKeyValuePairs(pydantic.BaseModel):
    ...
    def _validate_key(cls, key: DebugVariableValue, values: DebugKeyValuePairs.Partial) -> DebugVariableValue:
        for validator in DebugKeyValuePairs.Validators._key_validators:
            key = validator(key, values=values)
        return key

    @pydantic.validator("value")
    def _validate_value(cls, value: DebugVariableValue, values: DebugKeyValuePairs.Partial) -> DebugVariableValue:
