...
class Client:
    ...
    def store_traced_test_case(
        ...
        *,
        ...
        _response = requests.request("POST", "", json={"result": result, "traceResponses": trace_responses})
    ...
    def store_traced_workspace(
        ...
        *,
        ...
        _response = requests.request(
            "POST", "", json={"workspaceRunDetails": workspace_run_details, "traceResponses": trace_responses}
        )
