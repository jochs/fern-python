...
class ProblemClient:
    ...
    def get_lightweight_problems(self) -> typing.List[LightweightProblemInfoV2]:
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(typing.List[LightweightProblemInfoV2], _response.json())  # type: ignore
    ...
    def get_problems(self) -> typing.List[ProblemInfoV2]:
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(typing.List[ProblemInfoV2], _response.json())  # type: ignore
        raise ApiError(status_code=_response.status_code, body=_response_json)
    ...
    def get_latest_problem(self, problem_id: ProblemId) -> ProblemInfoV2:
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(ProblemInfoV2, _response.json())  # type: ignore
        raise ApiError(status_code=_response.status_code, body=_response_json)
