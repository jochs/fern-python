...
class ExceptionInfo(pydantic.BaseModel):
    ...
    class Validators:
        _exception_type_validators: typing.ClassVar[typing.List[typing.Callable[[str], str]]] = []
        _exception_message_validators: typing.ClassVar[typing.List[typing.Callable[[str], str]]] = []
        _exception_stacktrace_validators: typing.ClassVar[typing.List[typing.Callable[[str], str]]] = []
