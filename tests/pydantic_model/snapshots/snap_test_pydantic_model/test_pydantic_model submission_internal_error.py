...
class InternalError(pydantic.BaseModel):
    ...
    def _validate_exception_info(cls, exception_info: ExceptionInfo, values: InternalError.Partial) -> ExceptionInfo:
        for validator in InternalError.Validators._exception_info_validators:
            exception_info = validator(exception_info, values=values)
